...
from helpers import load_and_process_nba_data, get_dataset_summary, print_dataset_summary
    
data_path = os.path.join('backend', 'data', '2001-2022_data', 'nba')
...
def main():
    ...
    sample_df = load_and_process_nba_data(data_path, sample_file=sample_file)
    print("\nFirst few rows:")
    ...
    if(os.path.exists(processed_path)):
        ...
        full_df = load_and_process_nba_data(data_path)
